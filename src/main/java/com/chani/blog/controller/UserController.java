...
import com.chani.blog.model.KakaoProfile;
import com.chani.blog.model.OAuthToken;
...
public class UserController {
	...
	public  String kakaoCallback(String code) {  // @ResponseBody -> Data를 리턴해주는 컨트롤러 함수
		...
		params.add("client_id", "820cc397b4434b3014a50d932c04c2ba");
		...
		if(originUser.getUsername() == null) {
			...
			userService.joinMemer(kakaoUser);
		}
